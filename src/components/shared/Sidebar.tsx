    ...
    return (
        <button onClick={onClick}
            ...
            <AnimatePresence exitBeforeEnter>
                {
                    open ?
                        <motion.div key={"1"} transition={{duration: 0.3}} exit={{rotate: '-180deg'}}>
                            <IoChevronForwardOutline/>
                        </motion.div> :
                        <motion.div key={"2"} transition={{duration: 0.3}} exit={{rotate: '180deg'}}>
...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div
                className={classNames("lg:col-span-3 lg:transition-none transition-all duration-300 h-full order-3 lg:col-span-3 flex fixed sm:col-span-4",
                    "lg:w-full w-[320px] bg-nav rounded-lg lg:sticky sm:top-16 top-14 lg:bg-transparent lg:right-0 flex-col gap-y-10 lg:p-4 p-2",
